...
#include "nordic.h"
#include "gpio.h"
#define nrf_chip_enable PTC_BASE_PTR->PCOR = 1<<3;
#define nrf_chip_disable PTC_BASE_PTR->PSOR =  1<<3;
#define nrf_transmit_enable  PTC_BASE_PTR->PCOR = 1<<3;
#define nrf_transmit_disable PTC_BASE_PTR->PSOR = 1<<3;
