...
#include <stdint.h>
#define nrf_chip_enable() GPIOC->PCOR = 1<<4;
#define nrf_chip_disable() GPIOC->PSOR =  1<<4;
#define nrf_transmit_enable() GPIOC->PCOR = 1<<2;
#define nrf_transmit_disable() GPIO->PSOR = 1<<2;
